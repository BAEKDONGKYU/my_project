...
<script src="../js/readboard.js"></script>
</head>
<body>
					...
					<table class="table">
						...
						<tr>
							<td colspan="4" class="text-center">
								...
								<input type="button" class="btn btn-danger" value="삭제하기" id="delete">
								<input type="button" class="btn btn-primary" value="목록보기" id="list">
							</td>
						</tr>
						<input type="hidden" value="<%=bNum%>" id="hiddenNum">
						<input type="hidden" value="<%=bAuthor%>" id="hiddenAuthor">
